# listar itens do pedido que o motoboy vai levar
...
cliente = Cliente("Samuel", "123456789","rua das flores")
cliente2 = Cliente("João", "987654321","rua do contorno")
...
pedido02.adicionar_produto(pizza2)
...
#pedido01.remover_produto(sobremesa1)
pedido01.listarProdutos()
